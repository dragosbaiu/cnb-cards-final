      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10">
          ...
          <div className="md:col-span-2">
            <span className="text-xl font-bold tracking-tight">CNB Cards</span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/shop/singles" className="text-sm text-white/60 hover:text-white transition-colors">
                  {t("footer_shop")}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/returns" className="text-sm text-white/60 hover:text-white transition-colors">
                  {t("footer_returns")}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="mailto:contact@cnbcards.com"
              ...
              <li>
                <button
                  ...
                  className="text-sm text-white/60 hover:text-white transition-colors"
                >
                  {language === "en" ? "Language: EN / RO" : "Limba: RO / EN"}
                </button>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center">
          <p className="text-sm text-white/40">{t("footer_copyright")}</p>
        </div>
      </div>
    </footer>
  );
